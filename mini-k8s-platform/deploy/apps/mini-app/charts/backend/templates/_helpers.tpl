...
helm.sh/chart: {{ include "mini-app.chart" . }}
...
*/}}
{{- define "mini-app.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "mini-app.fullname" .) .Values.serviceAccount.name }}
{{- else }}
